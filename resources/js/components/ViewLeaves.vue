<template>
    <div>
        <div class="form-check float-right">
                    <input class="form-check-input" type="checkbox" v-model="includePastLeaves" id="pastLeaves">
...
export default {
        ...
        computed: {
            filteredLeaves: function() {
                ...
                return this.leaves.filter(l => this.includePastLeaves || this.$moment(
                            l.end_date).isAfter(this.$moment()) );
            }
        },  
        mounted() {
        },
