    ...
    <div>
        <div class="row">
          <div class="col-md-12">
            ...
            <ul class="groupInfo">
                <li v-if="group.parent_organization">Folder: <strong><router-link :to="{ name: 'groupList', params: { parent: group.parent_organization.id } }">{{ group.parent_organization.group_title }}</router-link></strong></li>
