...
export const leaveTypes = {
  ...
  COURSE_RELEASE_ADMINISTRATIVE: "course_release_administrative",
...
export const leaveTypeLabels: Record<LeaveType, string> = {
  ...
  [leaveTypes.DEVELOPMENT]: "Development",
  [leaveTypes.SINGLE_SEMESTER]: "Single Semester",
  [leaveTypes.COURSE_RELEASE]: "Course Release",
  [leaveTypes.COURSE_RELEASE_ADMINISTRATIVE]: "Course Release (Administrative)",
