...
export default defineConfig({
  ...
  css: {
    preprocessorOptions: {
      scss: {
        // bootstrap 4 has a deprecated abs() function
        // which causes vite to show warnings on each change
        // this quiets those warnings until we can update to bootstrap 5
        quietDeps: true,
        loadPaths: ["node_modules"],
        // bs4 also deprecation @import. Update to BS5 to resolve.
